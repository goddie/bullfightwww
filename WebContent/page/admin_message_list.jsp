										...
										<thead>
											<tr role="row">
												...
												<th class="sorting" role="columnheader" tabindex="0"
													...
													style="width: 224px;">收件人</th>
												<th class="sorting" role="columnheader" tabindex="0"
													aria-controls="example" rowspan="1" colspan="1"
													aria-label="Platform(s): activate to sort column ascending">标题</th>
												<th class="sorting" role="columnheader" tabindex="0"
													aria-controls="example" rowspan="1" colspan="1"
										...
										<tbody role="alert" aria-live="polite" aria-relevant="all">
											...
											<c:forEach var="m" varStatus="status" items="${list}">
												...
												<tr class="gradeA odd">
													...
													<td class="">${m.sendTo.member.username}</td>
													<td class="">${m.title}</td>
													<td class="center ">${m.content}</td>
													<td class="center ">${m.status}</td>

													<td class="center ">${m.createdDate}</td>
													<td class="action"><a href="${pageContext.request.contextPath}/message/edit/${m.id}"> 编辑 </a> <a href="${pageContext.request.contextPath}/message/del/${m.id}">
															删除 </a></td>
												</tr>
											</c:forEach>
										</tbody>
