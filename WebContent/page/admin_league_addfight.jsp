			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<iframe marginheight="0" marginwidth="0" frameborder="0"
						width="100%"
						src="${pageContext.request.contextPath}/leagueteam/admin/leaguesel?id=${league.id}"></iframe>
				</div>
			</div>
		</div>
	</div>
								...
								<form action="${pageContext.request.contextPath}/matchfight/add"
									...
									<fieldset>
										<input type="hidden" name="leagueid" id="leagueid"
											value="${league.id }" /> <input type="hidden"
											name="matchType" id="matchType" value="3" /> <input
											type="hidden" name="arenaid" id="arenaid"
											value="${league.arena.id }" /> <input type="hidden" name="teamSize"
											id="teamSize" value="5" /> <input name="judge" id="judge"
											type="hidden" value="1" /> <input name="dataRecord"
											id="dataRecord" value="3" type="hidden" />

										<div class="form-group">
											<label class="col-lg-2 control-label" for="typeahead">联赛名称:</label>
											<div class="col-lg-10">
