									...
									<table class="table table-striped table-bordered dataTable"
										...
										<thead>
											...
											<th class="sorting" role="columnheader" tabindex="0"
													...
													style="width: 12%;">用户名</th>
												<th class="sorting_asc" role="columnheader" tabindex="0"
													aria-controls="example" rowspan="1" colspan="1"
													aria-sort="ascending"
													aria-label="Rendering engine: activate to sort column descending"
													style="width: 12%;">最后球队</th>
												<th class="sorting" role="columnheader" tabindex="0"
													aria-controls="example" rowspan="1" colspan="1"
													aria-label="Browser: activate to sort column ascending"
													style="width: 12%;">最后号码</th>
												...
												<th class="sorting" role="columnheader" tabindex="0"
													...
													style="width: 12%;">手机号</th>

											</tr>
										</thead>

										<tbody role="alert" aria-live="polite" aria-relevant="all">
											<c:forEach var="player" items="${page.result}">

												<tr class="gradeA odd">

													<td class=" ">${player.name}</td>
													<td class=" ">${player.member.username}</td>
													<td class=" ">${player.lastTeam}</td>
													<td class=" ">${player.lastNo}</td>
