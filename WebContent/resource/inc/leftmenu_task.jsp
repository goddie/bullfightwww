...
<ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
	<li><a href="#"><i class="glyphicon glyphicon-chevron-down"></i>发布的任务</a>
		<ul class="nav navbar-collapse bootstrap-admin-navbar-side">
			<li><a
				href="${pageContext.request.contextPath}/task/admin/list"><i
			...
			<li><a
				href="${pageContext.request.contextPath}/task/admin/list"><i
					class="glyphicon glyphicon-chevron-right"></i>动漫招标</a></li>
			<li><a
				href="${pageContext.request.contextPath}/task/admin/list"><i
					class="glyphicon glyphicon-chevron-right"></i>动漫交付</a></li>
			<li><a
				href="${pageContext.request.contextPath}/task/admin/list"><i
					class="glyphicon glyphicon-chevron-right"></i>定向发布</a></li>
		</ul></li>
	...
	<li><a href="#"><i class="glyphicon glyphicon-chevron-down"></i>维权管理</a>
		<ul class="nav navbar-collapse bootstrap-admin-navbar-side">
			<li><a href="${pageContext.request.contextPath}"><i
					class="glyphicon glyphicon-chevron-right"></i>维权管理</a></li>
		</ul></li>
	<li><a href="#"><i class="glyphicon glyphicon-chevron-down"></i>关注的人才</a>
		<ul class="nav navbar-collapse bootstrap-admin-navbar-side">
			<li><a href="${pageContext.request.contextPath}"><i
