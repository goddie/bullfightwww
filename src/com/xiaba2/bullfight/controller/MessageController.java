...
public class MessageController {
	...
	public JsonResult jsonInvite(@RequestParam("uid") String uid,
	...
	public JsonResult jsonDelete(@RequestParam("uid") String uid,
	 ...
	 * @return
	 */
	@RequestMapping(value = "/json/delmessage")
	public JsonResult jsonDelMessage(@RequestParam("mid") UUID mid) {
		JsonResult rs = new JsonResult();
